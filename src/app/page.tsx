...
return ( <main className="min-h-screen bg-white"> <div className="mx-auto flex min-h-screen w-full max-w-5xl flex-col px-6 py-10">
{/* Cabeçalho */} <header className="mb-12 text-center"> <div className="mb-6"> <h1 className="text-4xl font-bold text-[#12223f] font-['Montserrat']">
Quality{" "} <span className="text-[#12223f] font-['Pacifico']">
Auditoria </span> </h1>
    ...
    <section className="flex-1">
      ...
      <div className="grid gap-5 sm:grid-cols-2">
        ...
        >
          ...
          <p className="mt-2 text-sm text-gray-600">
            Gerencie checklists, versões, seções e itens de auditoria.
          </p>
